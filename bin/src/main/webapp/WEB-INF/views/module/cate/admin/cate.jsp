...
<script type="text/javascript">
    ...
    function jsModForm(no_cate) {

        var form = document.createElement("form");
        var parm = new Array();
        var input = new Array();

        form.action = "<%=CateController.CATE_MOD_FORM%>";
        form.method = "post";


        parm.push( ['no_cate', no_cate] );
    ...
    function jsDel() {
        ...
        var del_length = $("#listForm").find("[name=del_no_cate]:checked").length;

        if(del_length<1) {
            alert("삭제할 상품 카테고리를 선택해 주세요.");
            return;
        }
        ...
        $.ajax({
            url: "<%=CateController.CATE_DEL_ACTION%>",
            data: data,
            contentType: "application/x-www-form-urlencoded; charset=UTF-8",
            type: "POST",
    ...
    function jsExcelDown(){
        ...
        f.action = '<%=CateController.CATE_LIST_EXCEL_DOWNLOAD%>';
        f.submit();
    }
...
<div class="contents">
    <div class="contents_now">
        <span>항목</span>
        <span>상품 관리</span>
        <span class="now_page">상품 카테고리 리스트</span>
    </div>
    ...
    <div class="common_title_wrap">
        ...
        <div class="btn_wrap">
            <div class="btn"><a href="javascript:;" onclick="jsRegForm();">+ 상품 카테고리 등록</a></div>
        </div>
    </div>
                ...
                <table>
                        ...
                        <td>
                            <div class="td_inner">
                                <div class="option_list w230">
                                    ${ufn:getSelectBox("sell_yn", "Y","sell_yn", true, "")}
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr class="search_word">
                        ...
                        <td>
                            <div class="td_inner">
                                <div class="option_list w230">
                                    ${ufn:getSelectBox("excg_yn", "Y","excg_yn", true, "")}
                                </div>
                            </div>
                        </td>
