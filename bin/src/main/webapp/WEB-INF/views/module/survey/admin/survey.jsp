...
<%@ page import="kr.co.msync.web.module.survey.SurveyController" %>
...
<script type="text/javascript">
    ...
    function jsList(page) {
        ...
        $.ajax({
            url: "<%=SurveyController.SURVEY_LIST%>",
            data: data,
...
<div class="side_menu_wrap">
    <ul>
        <li class="menu_title">
            <h2><a href="<%=SurveyController.SURVEY%>">설문 관리</a></h2>
            <ul>
                <li class="on"><h4><a href="<%=SurveyController.SURVEY%>">설문 리스트</a></h4></li>
            </ul>
        </li>
    </ul>
</div>
...
<div class="contents">
    <div class="contents_now">
        <span>설문</span>
        <span>설문 관리</span>
        <span class="now_page">설문 조회</span>
    </div>
        ...
        <div class="form_wrap">
            <form name="searchForm" id="searchForm" onsubmit="return false;" method="post">
                ...
                <table>
                    ...
                    <tr class="period">
                        <td class="infotd">기기타입</td>
                        <td>
                            <div class="td_inner">
                                <div class="option_list w230">
                                    ${ufn:getSelectBox("device_type", "Y", "device_type", true, "")}
                                </div>
                            </div>
                        </td>
