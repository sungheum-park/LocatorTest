...
<script type="text/javascript">
    ...
    function jsRegAction(){
        ...
        $("#regForm").validate({
            ...
            messages: {
                color_name: "색상명을 입력해 주세요.",
                color_rgb: "색상코드를 입력해 주세요."
        ...
        $("#regForm").ajaxForm({
            url: "<%=ColorController.COLOR_REG_ACTION%>",
            data: data,
    ...
    function jsSetColor(){
        var val = $("#regForm").find("[name=color_rgb]").val();
        if(val.length==7)
            $("#regForm .color_chip").css("background-color",val);
    }
    ...
    <ul>
        <li class="menu_title">
            ...
            <ul>
                ...
                <li class="on"><h4><a href="<%=ColorController.COLOR_REG_FORM%>">상품 색상 등록</a></h4></li>
...
<div class="contents">
    <div class="contents_now">
        <span>항목</span>
        <span>상품관리 관리</span>
        <span class="now_page">상품 색상 등록</span>
    </div>
                        ...
                        <td>
                            <div class="td_inner_2 ">
                                <div class="input_wrap w120 ml0 in-block">
                                    <input type="text" name="color_rgb" onkeyup="jsSetColor();" maxlength="7">
                                </div>
                                <div class="color_chip big"></div>
