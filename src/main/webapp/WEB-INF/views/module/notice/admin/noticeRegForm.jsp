...
<script type="text/javascript">
    ...
    function jsRegAction(){
        ...
        $("#regForm").ajaxForm({
            url: "<%=NoticeController.NOTICE_REG_ACTION%>",
            type: "POST",
            data: data,
...
<div class="side_menu_wrap">
    <ul>
        <li class="menu_title">
            ...
            <ul>
                <li><h4><a href="<%=NoticeController.NOTICE%>">공지사항 리스트</a></h4></li>
                <li class="on"><h4><a href="<%=NoticeController.NOTICE_REG_FORM%>">공지사항 등록</a></h4></li>
            </ul>
        </li>
    </ul>
</div>
...
<div class="contents">
    <div class="contents_now">
        <span>공지사항</span>
        <span>공지사항 관리</span>
        <span class="now_page">공지사항 등록</span>
    </div>
                ...
                <table>
                    ...
                    <tr class="period">
                        ...
                        <td class="inner_table">
                            <div class="td_inner">
                                ${ufn:getRadioButton('notice_div', 'y', 'notice_div', '01', '')}
                            </div>
                        </td>
                    </tr>
                    ...
                    <tr class="period">
                        ...
                        <td class="inner_table">
                            <div class="td_inner">
                                ${ufn:getRadioButton('display_yn', 'y', 'display_yn', 'Y', '')}
                            </div>
                        </td>
                    </tr>
                    <tr class="period">
