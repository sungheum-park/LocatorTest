...
<script type="text/javascript">
    ...
    function jsList(page) {
        ...
        $.ajax({
            url: "<%=DeviceController.DEVICE_LIST%>",
            data: data,
    ...
    function jsRegForm() {
        location.href="<%=DeviceController.DEVICE_REG_FORM%>";
    }

    function jsModForm(no_device) {

        var form = document.createElement("form");
        var parm = new Array();
        var input = new Array();

        form.action = "<%=DeviceController.DEVICE_MOD_FORM%>";
        form.method = "post";


        parm.push( ['no_device', no_device] );
    ...
    function jsDel() {
        ...
        var del_length = $("#listForm").find("[name=del_no_device]:checked").length;
        ...
        $.ajax({
            url: "<%=DeviceController.DEVICE_DEL_ACTION%>",
            data: data,
            contentType: "application/x-www-form-urlencoded; charset=UTF-8",
            type: "POST",
    ...
    function jsExcelDown(){
        ...
        f.action = '<%=DeviceController.DEVICE_LIST_EXCEL_DOWNLOAD%>';
        f.submit();
    }
...
<div class="contents">
    <div class="contents_now">
        <span>항목</span>
        <span>상품 관리</span>
        <span class="now_page">상품 리스트</span>
    </div>
    ...
    <div class="common_title_wrap">
        ...
        <div class="btn_wrap">
            <div class="btn"><a href="javascript:;" onclick="jsRegForm();">+ 상품 등록</a></div>
        </div>
    </div>
                        ...
                        <td>
                            <div class="td_inner">
                                <div class="option_list w230">
                                    ${ufn:getSelectByTable("tb_category", "no_cate", "no_cate", "cate_name", "N", true, '')}
                                </div>
                            </div>
                        </td>
