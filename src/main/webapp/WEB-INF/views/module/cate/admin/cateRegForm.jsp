...
<script type="text/javascript">
    ...
    function jsRegAction(){
        ...
        $("#regForm").ajaxForm({
            url: "<%=CateController.CATE_REG_ACTION%>",
            type: "POST",
            data: data,
    ...
    <ul>
        <li class="menu_title">
            ...
            <ul>
                ...
                <li class="on"><h4><a href="<%=CateController.CATE_REG_FORM%>">상품 카테고리 등록</a></h4></li>
            </ul>
        </li>
        <li class="menu_title">
...
<div class="contents">
    <div class="contents_now">
        <span>항목</span>
        <span>상품 관리</span>
        <span class="now_page">상품 카테고리 등록</span>
    </div>
                ...
                <table>
                        ...
                        <td>
                            <div class="td_inner_2">
                                <div class="input_wrap w332 ml0">
                                    <input type="text" maxlength="25" name="cate_name">
                                </div>
                            </div>
                        </td>
                    </tr>
                    <tr class="period">
                        ...
                        <td class="inner_table">
                            <div class="td_inner">
                                ${ufn:getRadioButton('sell_yn', 'y', 'sell_yn', 'Y', '')}
                            </div>
                        </td>
                    </tr>
                    <tr class="period">
                        ...
                        <td class="inner_table">
                            <div class="td_inner">
                                ${ufn:getRadioButton('excg_yn', 'y', 'excg_yn', 'Y', '')}
                            </div>
                        </td>
                    </tr>
                    <tr class="search_word">
