...
<script type="text/javascript">
    $(document).ready(function(){
        $("#modForm").find("[name=store_status]").bind("click",function(){
            if($(this).val()=="02") {
        ...
        $('.sale_item .button_90').bind("click",function(){
            ...
            $("#modForm").find("[name=selected_sell_no_cate]").each(function(i){
                if(i==0) {
        ...
        $('.change_item .button_90').bind("click",function(){
            ...
            $("#modForm").find("[name=selected_excg_no_device]").each(function(i){
                if(i==0) {
        ...
        $('.offer_service .button_90').bind("click",function(){
            ...
            $("#modForm").find("[name=selected_no_service]").each(function(i){
                if(i==0) {
    ...
    function jsModAction(){
        ...
        $("#modForm").ajaxForm({
            url: "<%=StoreController.STORE_MOD_ACTION%>",
            type: "POST",
            data: data,
    ...
    <ul>
        <li class="menu_title">
            ...
            <ul>
                ...
                <li><h4><a href="<%=StoreController.STORE_REG_FORM%>">매장 수정</a></h4></li>
            </ul>
        </li>
        <li class="menu_title">
...
<div class="contents">
    <div class="contents_now">
        <span>매장</span>
        <span>매장 관리</span>
        <span class="now_page">매장 수정</span>
    </div>
                    ...
                    <td>
                        <div class="td_inner_2">
                            <div class="option_list w283">
                                ${ufn:getStoreSelectBox("store_type","Y","store_type", false, vo.store_type ,inclusive_code)}
                            </div>
                        </div>
                    </td>
                </tr>
            ...
            <table>
                    ...
                    <td colspan="3">
                        <div class="td_inner_2">
                            <div class="input_wrap ml0 w332">
                                <input class="number_type" type="number" name="retail_store_code" maxlength="20" value="${vo.retail_store_code}">
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td colspan="3">
                        <div class="td_inner_2">
                            <div class="input_wrap ml0">
                                <input type="text" maxlength="60" name="store_name" value="${vo.store_name}" maxlength="60">
                            </div>
                        </div>
                    </td>
                </tr>
                <tr class="search_word">
                    ...
                    <td colspan="3">
                        <div class="td_inner_2">
                            <div class="input_wrap ml0">
                                <input type="text" maxlength="100" name="store_addr" value="${vo.store_addr}">
                            </div>
                        </div>
                    </td>
                </tr>
                <tr class="search_word">
                    ...
                    <td colspan="3">
                        <div class="td_inner_2">
                            <div class="input_wrap ml0">
                                <input type="text" maxlength="150" name="store_addr_dtl" value="${vo.store_addr_dtl}">
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td colspan="3">
                        <div class="td_inner_2">
                            ...
                            <div class="input_wrap w332">
                                <input type="text" name="lat_long_spot" readonly="readonly" value="${vo.latitude}, ${vo.longitude}">
                ...
                <tr class="search_word">
                    ...
                    <td colspan="3">
                        <div class="td_inner_2">
                            <div class="input_wrap ml0">
                                <input type="text" maxlength="300" name="come_way" value="${vo.come_way}">
                            </div>
                        </div>
                    </td>
                </tr>
                <tr class="search_word">
                    ...
                    <td class="destd">
                        <div class="td_inner_2">
                            <div class="input_wrap ml0">
                                <input type="text" maxlength="30" name="tel_num" value="${vo.tel_num}">
                            </div>
                        </div>
                    </td>
                ...
                <tr class="search_word">
                    ...
                    <td class="destd">
                        <div class="td_inner_2">
                            <div class="input_wrap ml0">
                                <input type="text" maxlength="50" name="oper_time" value="${vo.oper_time}">
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="destd">
                        <div class="td_inner_2">
                            <div class="input_wrap ml0">
                                <input type="text" maxlength="50" name="as_time" value="${vo.as_time}">
                            </div>
                        </div>
                    </td>
                </tr>
...
*권장드리는 사이즈로 업로드 하지 않으실 경우, 해당 이미지가 잘려보일 수 있는점 참고부탁드립니다.</span>
                        <div class=image>
                            <div class="image_wrap">
                                <c:choose>
                                    <c:when test="${empty vo.photo_files}">
                                        <div class="button_90">
                                    ...
                                    <c:otherwise>
                                        <c:forEach var="file" items="${vo.photo_files}" varStatus="status">
                                            <div class="button_90">
                                                <input type="hidden" name="no_file_array" value="${file.no_file}"/>
                                                <span class="sno_handle img_handle"></span>
                                                <input type="file" id="file_${status.count}" name="store_img_file_${status.count}" class="download_btn blind upload-hidden" onchange="fileValidate(this);">
                                                <label for="file_${status.count}" class="download_btn">찾아보기</label>
                                                <input class="upload-name upload_img" readonly="readonly" value="${file.origin_name}">
                                                <input type="hidden" name="file_sno" value="${status.count}">
                                                <span class="add_btn" onclick="addPhotoBtn();">+ 추가</span>
                                                <span class="delete_btn" onclick="removePhotoBtn(this);">- 삭제</span>
                                                <div class="file_name">
                                                    <span class="file_thumb" onclick="jsImagePreview(this)">
                                                        <img src="${file.file_path}${file.save_name}" alt="">
                                                    </span>
                                                </div>
                                            </div>
                                        </c:forEach>
        ...
        <div class="form_wrap">
            <table>
                ...
                <tr class="block">
                    ...
                    <td class="text_area">
                        <div class="td_inner_2">
                            <textarea name="cust_desc" maxlength="1000">${vo.cust_desc}</textarea>
                        </div>
                    </td>
                </tr>
            </table>
