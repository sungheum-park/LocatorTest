...
<script type="text/javascript">
    ...
    function jsModAction(){
        ...
        $("#modForm").ajaxForm({
            url: "<%=ServiceController.SERVICE_MOD_ACTION%>",
            type: "POST",
            data: data,
...
<div class="contents">
    <div class="contents_now serviceModify">
        <span>항목</span>
        <span>서비스 관리</span>
        <span class="now_page">서비스 수정</span>
    </div>
    ...
    <form name="modForm" id="modForm" onsubmit="return false;" method="post" enctype="multipart/form-data">
        <input type="hidden" name="no_service" value="${vo.no_service}">
    <!-- 공통 검색폼 -->
                    ...
                    <td>
                        <div class="td_inner_2">
                            <div class="option_list w283">
                                ${ufn:getSelectBox("service_div","Y","service_div", false, vo.service_div)}
                            </div>
                        </div>
                    </td>
                </tr>
                    ...
                    <td>
                        <div class="td_inner_2">
                            <div class="input_wrap w283 ml0">
                                <input type="text" name="service_name" value="${vo.service_name}">
                            </div>
                        </div>
                    </td>
                </tr>
                <tr class="search_word">
                    ...
                    <td colspan="3" class="text_area">
                        <div class="input_wrap ml0">
                            <textarea name="comment" maxlength="1000">${vo.comment}</textarea>
                        </div>
                    </td>
                </tr>
                <tr class="period">
                        ...
                        <div class=image>
                                <div class="image_wrap">
                                    <div class="button_90">
                                        ...
                                        <input class="upload-name  upload_img" readonly="readonly" value="${vo.origin_name}">
                                        <div class="file_name">
